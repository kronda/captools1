...
projects[metaltoad][download][revision] = "6.x"' > kickstart.make
...
echo "<?php
\$db_url = 'mysql://$dbuser:$dbpassword@localhost/$dbname';
\$db_prefix = '';" > drupal/sites/default/local_settings.php
